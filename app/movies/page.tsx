        ...
        <div className="flex flex-col gap-28 md:flex-row">
          ...
          <main className="flex-1 pb-16">
            <div className="mb-12 text-center">
              <h1 className="mb-4 text-5xl font-bold">Movies That I Have Watched Recently</h1>
            </div>
              ...
              {movies.map((movie) => (
                ...
                >
                  <div className="flex h-full flex-col md:flex-row">
                    <div className="h-105 shrink-0 md:h-full md:w-64">
                      <img
                        src={movie.poster}
                        alt={movie.title}
                    ...
                    <div className="flex flex-1 flex-col justify-between p-6 md:p-8">
                      <div>
                        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                          ...
                          <div
                            className="
                              w-fit rounded-full border-2 border-black
                              px-5 py-2 text-xl md:text-2xl
                            "
                          >
                            {movie.rating}/10
                          </div>
                        ...
                        <p
                          className="
                            ...
                            md:mt-8 md:text-xl md:line-clamp-4
                          "
                        >
                          "{movie.comment}"
                        </p>
